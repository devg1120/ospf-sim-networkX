...
if __name__ == '__main__':
    ...
    subnet7 = manager_subnet.create("10.2.5.0/24")
    ...
    RD = router.Router("RouterD", asys, manager_subnet)
    RD.iface_create("eth0", 1000)
    RD.iface_config("eth0", "10.2.5.1", "255.255.255.0")
    RD.iface_create("eth1", 1000)
    RD.iface_config("eth1", "10.3.2.100", "255.255.255.0")
